...
CREATE TABLE FACTURACION.EVENTO_INGESTA (
    ...
    ORIGEN         VARCHAR(50) NOT NULL,                     -- p. ej. 'email_listener'
    DATOS_JSON     JSONB NOT NULL,                           -- El payload completo en JSON
    INTENTOS       INTEGER DEFAULT 0                         -- Para manejar reintentos
);

COMMENT ON TABLE FACTURACION.EVENTO_INGESTA IS 'Cola de entrada para eventos detectados por los listeners de facturación.';
